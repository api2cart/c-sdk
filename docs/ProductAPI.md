...
[**ProductAPI_productOptionValueDelete**](ProductAPI.md#ProductAPI_productOptionValueDelete) | **DELETE** /product.option.value.delete.json | product.option.value.delete
...
**store_id** | **char \*** | Store Id | [optional] 
**include_default** | **int \*** | Boolean, whether or not to unset default value of the attribute, if applicable | [optional] [default to false]
**reindex** | **int \*** | Is reindex required | [optional] [default to true]
**clear_cache** | **int \*** | Is cache clear required | [optional] [default to true]

### Return type

[product_attribute_value_unset_200_response_t](product_attribute_value_unset_200_response.md) *
