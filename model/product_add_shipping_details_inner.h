/*
 * product_add_shipping_details_inner.h
 *
 * 
 */

#ifndef _product_add_shipping_details_inner_H_
#define _product_add_shipping_details_inner_H_
...
typedef struct product_add_shipping_details_inner_t product_add_shipping_details_inner_t;




typedef struct product_add_shipping_details_inner_t {
    char *shipping_type; // string
    char *shipping_service; // string
...
#endif /* _product_add_shipping_details_inner_H_ */
