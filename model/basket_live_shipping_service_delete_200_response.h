/*
 * basket_live_shipping_service_delete_200_response.h
 *
 * 
 */

#ifndef _basket_live_shipping_service_delete_200_response_H_
#define _basket_live_shipping_service_delete_200_response_H_
...
typedef struct basket_live_shipping_service_delete_200_response_t basket_live_shipping_service_delete_200_response_t;

#include "basket_live_shipping_service_delete_200_response_result.h"



typedef struct basket_live_shipping_service_delete_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct basket_live_shipping_service_delete_200_response_result_t *result; //model
...
#endif /* _basket_live_shipping_service_delete_200_response_H_ */
