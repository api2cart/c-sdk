/*
 * product_delete_batch_payload_inner.h
 *
 * 
 */

#ifndef _product_delete_batch_payload_inner_H_
#define _product_delete_batch_payload_inner_H_
...
typedef struct product_delete_batch_payload_inner_t product_delete_batch_payload_inner_t;




typedef struct product_delete_batch_payload_inner_t {
    char *id; // string
...
#endif /* _product_delete_batch_payload_inner_H_ */
