/*
 * return_action_list_200_response.h
 *
 * 
 */

#ifndef _return_action_list_200_response_H_
#define _return_action_list_200_response_H_
...
typedef struct return_action_list_200_response_t return_action_list_200_response_t;

#include "return_action_list_200_response_result.h"



typedef struct return_action_list_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct return_action_list_200_response_result_t *result; //model
...
#endif /* _return_action_list_200_response_H_ */
