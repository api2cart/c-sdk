/*
 * customer_group_add_200_response.h
 *
 * 
 */

#ifndef _customer_group_add_200_response_H_
#define _customer_group_add_200_response_H_
...
typedef struct customer_group_add_200_response_t customer_group_add_200_response_t;

#include "customer_group_add_200_response_result.h"



typedef struct customer_group_add_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct customer_group_add_200_response_result_t *result; //model
...
#endif /* _customer_group_add_200_response_H_ */
