...
#ifndef _product_add_batch_H_
#define _product_add_batch_H_
...
typedef struct product_add_batch_t product_add_batch_t;

#include "product_add_batch_payload_inner.h"

// Enum NESTEDITEMSUPDATEBEHAVIOUR for product_add_batch

typedef enum  { api2cart_openapi_product_add_batch_NESTEDITEMSUPDATEBEHAVIOUR_NULL = 0, api2cart_openapi_product_add_batch_NESTEDITEMSUPDATEBEHAVIOUR_replace, api2cart_openapi_product_add_batch_NESTEDITEMSUPDATEBEHAVIOUR_merge } api2cart_openapi_product_add_batch_NESTEDITEMSUPDATEBEHAVIOUR_e;
...
typedef struct product_add_batch_t {
    api2cart_openapi_product_add_batch_NESTEDITEMSUPDATEBEHAVIOUR_e nested_items_update_behaviour; //enum
