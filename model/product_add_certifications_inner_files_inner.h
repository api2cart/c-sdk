/*
 * product_add_certifications_inner_files_inner.h
 *
 * 
 */

#ifndef _product_add_certifications_inner_files_inner_H_
#define _product_add_certifications_inner_files_inner_H_
...
typedef struct product_add_certifications_inner_files_inner_t product_add_certifications_inner_files_inner_t;




typedef struct product_add_certifications_inner_files_inner_t {
    char *url; // string
...
#endif /* _product_add_certifications_inner_files_inner_H_ */
