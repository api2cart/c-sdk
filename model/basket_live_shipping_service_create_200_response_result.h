/*
 * basket_live_shipping_service_create_200_response_result.h
 *
 * 
 */

#ifndef _basket_live_shipping_service_create_200_response_result_H_
#define _basket_live_shipping_service_create_200_response_result_H_
...
typedef struct basket_live_shipping_service_create_200_response_result_t basket_live_shipping_service_create_200_response_result_t;




typedef struct basket_live_shipping_service_create_200_response_result_t {
    int id; //numeric
...
#endif /* _basket_live_shipping_service_create_200_response_result_H_ */
