/*
 * model_response_order_abandoned_list.h
 *
 * 
 */

#ifndef _model_response_order_abandoned_list_H_
#define _model_response_order_abandoned_list_H_
...
typedef struct model_response_order_abandoned_list_t model_response_order_abandoned_list_t;
...
typedef struct model_response_order_abandoned_list_t {
    int return_code; //numeric
    char *return_message; // string
    struct pagination_t *pagination; //model
    struct response_order_abandoned_list_result_t *result; //model
...
#endif /* _model_response_order_abandoned_list_H_ */
