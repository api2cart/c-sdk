/*
 * response_customer_group_list_result.h
 *
 * 
 */

#ifndef _response_customer_group_list_result_H_
#define _response_customer_group_list_result_H_
...
typedef struct response_customer_group_list_result_t response_customer_group_list_result_t;
...
typedef struct response_customer_group_list_result_t {
    int group_count; //numeric
...
#endif /* _response_customer_group_list_result_H_ */
