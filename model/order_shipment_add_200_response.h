/*
 * order_shipment_add_200_response.h
 *
 * 
 */

#ifndef _order_shipment_add_200_response_H_
#define _order_shipment_add_200_response_H_
...
typedef struct order_shipment_add_200_response_t order_shipment_add_200_response_t;

#include "order_shipment_add_200_response_result.h"



typedef struct order_shipment_add_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct order_shipment_add_200_response_result_t *result; //model
...
#endif /* _order_shipment_add_200_response_H_ */
