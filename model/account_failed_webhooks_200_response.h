/*
 * account_failed_webhooks_200_response.h
 *
 * 
 */

#ifndef _account_failed_webhooks_200_response_H_
#define _account_failed_webhooks_200_response_H_
...
typedef struct account_failed_webhooks_200_response_t account_failed_webhooks_200_response_t;

#include "account_failed_webhooks_200_response_result.h"



typedef struct account_failed_webhooks_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct account_failed_webhooks_200_response_result_t *result; //model
...
#endif /* _account_failed_webhooks_200_response_H_ */
