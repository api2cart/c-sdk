/*
 * response_product_review_list_result.h
 *
 * 
 */

#ifndef _response_product_review_list_result_H_
#define _response_product_review_list_result_H_
...
typedef struct response_product_review_list_result_t response_product_review_list_result_t;
...
typedef struct response_product_review_list_result_t {
    int total_count; //numeric
    list_t *reviews; //nonprimitive container
...
#endif /* _response_product_review_list_result_H_ */
