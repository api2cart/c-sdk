/*
 * product_attribute_value_set_200_response.h
 *
 * 
 */

#ifndef _product_attribute_value_set_200_response_H_
#define _product_attribute_value_set_200_response_H_
...
typedef struct product_attribute_value_set_200_response_t product_attribute_value_set_200_response_t;

#include "product_attribute_value_set_200_response_result.h"



typedef struct product_attribute_value_set_200_response_t {
    int return_code; //numeric
    char *return_message; // string
    struct product_attribute_value_set_200_response_result_t *result; //model
...
#endif /* _product_attribute_value_set_200_response_H_ */
