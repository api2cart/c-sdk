/*
 * response_cart_script_list_result.h
 *
 * 
 */

#ifndef _response_cart_script_list_result_H_
#define _response_cart_script_list_result_H_
...
typedef struct response_cart_script_list_result_t response_cart_script_list_result_t;
...
typedef struct response_cart_script_list_result_t {
    int total_count; //numeric
    list_t *scripts; //nonprimitive container
...
#endif /* _response_cart_script_list_result_H_ */
